    ...
    <div>
      <div className={classes.matchup}>
        <motion.div
          ...
          className={selectedWinner && selectedWinner.track.id === teams[0].track.id ? `${classes.team} ${classes.active}` : `${classes.team}`}
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.1 }}
          className={selectedWinner && selectedWinner.track.id === teams[1].track.id ? `${classes.team} ${classes.active}` : `${classes.team}`}
      ...
      {selectedWinner && (
        ...
        transition={{
          ...
          <motion.button whileHover={{ scale: 1.1 }} className={classes.button} onClick={confirmWinner}>Confirm</motion.button>
        </motion.div>
      )}
    </div>
  );
